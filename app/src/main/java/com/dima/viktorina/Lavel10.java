...
public class Lavel10 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text_levels.setText(R.string.lavel10); //Задали текст
        ...
        button_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    Intent intent = new Intent(Lavel10.this, GameLevels.class);
        ...
        imgprev.setImageResource(R.drawable.img_prev_dialog10);
        ...
        textdescription.setText(R.string.levelsten);
        ...
        textExit.setText(R.string.dialogtextexit10);
        ...
        btncontinue2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    Intent intent2 = new Intent(Lavel10.this, GameLevels.class);
        ...
        final Animation a = AnimationUtils.loadAnimation(Lavel10.this, R.anim.alpha);
        ...
        img_left.setImageResource(array.images10[numLeft]); //Берём картинку из массива
        text_left.setText(array.text10[numLeft]); //Берём из массива текст
        ...
        text_right.setText(array.text10[numRight]);
                ...
                if (motionEvent.getAction() == MotionEvent.ACTION_DOWN){
                   ...
                   //Если коснулся картинки конец
                    ...
                    if (count == 20){
                        ...
                        konfettiView.build()
                                .addColors(Color.WHITE, Color.RED, Color.WHITE)
