...
public class Lavel2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text_levels.setText(R.string.lavel2); //Задали текст
        ...
        button_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    Intent intent = new Intent(Lavel2.this, GameLevels.class);
        ...
        imgprev.setImageResource(R.drawable.img_prev_lavel2);
        ...
        textdescription.setText(R.string.levels2);
        ...
        textExit.setText(R.string.dialogtextexit2);
        ...
        btncontinue2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    Intent intent2 = new Intent(Lavel2.this, GameLevels.class);
        ...
        final Animation a = AnimationUtils.loadAnimation(Lavel2.this, R.anim.alpha);
        ...
        //Для левой части
        numLeft = random.nextInt(10); //Генерация случайных чисел от 1 до 10
        img_left.setImageResource(array.images2[numLeft]); //Берём картинку из массива
        text_left.setText(array.text2[numLeft]); //Берём из массива текст
