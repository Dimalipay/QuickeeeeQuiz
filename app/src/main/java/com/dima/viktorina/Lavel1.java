...
public class Lavel1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text_levels.setText(R.string.lavel1); //Задали текст
        ...
        button_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    Intent intent = new Intent(Lavel1.this, GameLevels.class);
        ...
        btncontinue2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    Intent intent2 = new Intent(Lavel1.this, GameLevels.class);
        ...
        final Animation a = AnimationUtils.loadAnimation(Lavel1.this, R.anim.alpha);
        ...
        img_left.setImageResource(array.images1[numLeft]); //Берём картинку из массива
        text_left.setText(array.text1[numLeft]); //Берём из массива текст
