...
public class Lavel12 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text_levels.setText(R.string.lavel12); //Задали текст
        ...
        button_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    Intent intent = new Intent(Lavel12.this, GameLevels.class);
        ...
        imgprev.setImageResource(R.drawable.img_prev_dialog12);
        ...
        textdescription.setText(R.string.levelstwelve);
        ...
        textExit.setText(R.string.dialogtextexit12);
        ...
        btncontinue2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    Intent intent2 = new Intent(Lavel12.this, GameLevels.class);
        ...
        text_left.setText(array.text12[numLeft]); //Берём из массива текст
        ...
        text_right.setText(array.text12[numRight]);
