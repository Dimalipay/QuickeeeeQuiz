...
public class Lavel14 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text_levels.setText(R.string.lavel14); //Задали текст
        ...
        button_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    Intent intent = new Intent(Lavel14.this, GameLevels.class);
        ...
        imgprev.setImageResource(R.drawable.img_prev_dialog14);
        ...
        textdescription.setText(R.string.levels14);
        ...
        btncontinue2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    Intent intent2 = new Intent(Lavel14.this, GameLevels.class);
        ...
        final Animation a = AnimationUtils.loadAnimation(Lavel14.this, R.anim.alpha);
        ...
        text_left.setText(array.text14[numLeft]); //Берём из массива текст
        ...
        text_right.setText(array.text14[numRight]);
