...
public class Lavel3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text_levels.setText(R.string.lavel3); //Задали текст
        ...
        button_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    Intent intent = new Intent(Lavel3.this, GameLevels.class);
        ...
        imgprev.setImageResource(R.drawable.img_prev_dialog3);
        ...
        textExit.setText(R.string.dialogtextexit3);
        ...
        btncontinue2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    Intent intent2 = new Intent(Lavel3.this, GameLevels.class);
        ...
        final Animation a = AnimationUtils.loadAnimation(Lavel3.this, R.anim.alpha);
        ...
        img_left.setImageResource(array.images3[numLeft]); //Берём картинку из массива
        text_left.setText(array.text3[numLeft]); //Берём из массива текст
