...
public class Lavel18 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text_levels.setText(R.string.lavel18); //Задали текст
        ...
        button_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    Intent intent = new Intent(Lavel18.this, GameLevels.class);
        ...
        imgprev.setImageResource(R.drawable.img_prev_dialog18);
        ...
        textdescription.setText(R.string.levels18);
        ...
        textExit.setText(R.string.dialogtextexit18);
        //Кнопка закрытия диалогового окна - начало
        ...
        btncontinue2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    Intent intent2 = new Intent(Lavel18.this, GameLevels.class);
        ...
        final Animation a = AnimationUtils.loadAnimation(Lavel18.this, R.anim.alpha);
        ...
        img_left.setImageResource(array.images18[numLeft]); //Берём картинку из массива
        text_left.setText(array.text18[numLeft]); //Берём из массива текст
        ...
        text_right.setText(array.text18[numRight]);
